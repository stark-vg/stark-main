...
if(isset($_POST['update']))
{
	...
	if ($pass1!=$pass2){
		...
		window.alert('$error')
		window.location.href='changepassemp.php';
		</SCRIPT>");
		exit;
	}
	$sql = "UPDATE `employee` SET `password`='$pass1' WHERE id = $id";
...
<head>
  ...
  <title>Change Password | STARK IOT'S</title>
        ...
        <div class="wrapper wrapper--w680">
            <div class="card card-1">
                ...
                <div class="card-body">
                    ...
                    <form id = "frmchangepassword" action="changepassemp.php" method="POST">

                          <div class="row row-space">
                            <div class="col-4">
                                <div class="input-group">
                                  <p>Old Password</p>
                                     <input class="input--style-1" type="Password" name = "oldpass" required  value="<?php echo $old;?>" readonly>
                                </div>
                            </div>
                            <div class="col-4">
                                <div class="input-group">
                            ...
                            <div class="col-4">
                                <div class="input-group">
                                  <p>Confirm New Password</p>
                                     <input class="input--style-1" type="Password" name = "confirmnewpass" required >
                                </div>
                            </div>
