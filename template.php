...
/*$id = (isset($_GET['id']) ? $_GET['id'] : '');
	require_once ('process/dbh.php');
	 ...
	 $empName = $employeen['firstName'].' '.$employeen['lastName'];
echo $sql1;	
$result1 = mysqli_query($conn, $sql1);
*/
?>
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
        ...
        <div class="sidebar-brand-text mx-3">STARK IOT'S<sup>2</sup></div>
      </a>
      ...
      <li class="nav-item">
        ...
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="#">Room:1</a>
            <a class="collapse-item" href="#">Room:2</a>
            <a class="collapse-item" href="#">Room:3</a>
            <a class="collapse-item" href="#">Room:4</a>
          </div>
        </div>
      </li>
